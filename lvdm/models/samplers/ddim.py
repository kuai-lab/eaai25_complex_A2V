...
class DDIMSampler(object):
    ...
    def sample(self,
        ...
        samples, intermediates = self.ddim_sampling(conditioning, size,
                                                    ...
                                                    toeplitz_matric=toeplitz_matric,
    ...
    def ddim_sampling(self, cond, shape,
                      ...
                      cond_tau=1., target_size=None, start_timesteps=None, args=None,
                      **kwargs):
    ...
    def p_sample_ddim(self, x, c, t, index, repeat_noise=False, use_original_steps=False, quantize_denoised=False,
                      ...
                      uc_type=None, conditional_guidance_scale_temporal=None, x0=None, step=None, args=None, **kwargs):
        ...
        if unconditional_conditioning is None or unconditional_guidance_scale == 1.:
            ...
            if isinstance(c, dict) and step < args.step_ctrl:
                ...
                e_t = self.model.apply_model(x, t, c, step=True, **kwargs)
                e_t_uncond = self.model.apply_model(x, t, unconditional_conditioning, e_t_uc=True, **kwargs)
            else:
